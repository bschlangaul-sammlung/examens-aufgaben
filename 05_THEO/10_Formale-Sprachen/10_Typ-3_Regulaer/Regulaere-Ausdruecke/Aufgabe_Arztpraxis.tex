...
\liLadePakete{syntax}
\begin{document}
\liAufgabenTitel{Arztpraxis und Autohauskette}
\section{Aufgabe 4: Reguläre Ausdrücke in JAVA:
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/theo_inf/regulaere_ausdruecke/KrankenversicherungsNummer}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/theo_inf/regulaere_ausdruecke/PasswortTuer}
\end{liAntwort}
