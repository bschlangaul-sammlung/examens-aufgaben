...
\begin{center}
\begin{tikzpicture}[->,node distance=3cm]
\node[state,initial,accepting,label=south:\p{z_0, z_1, z_2}] (0) {$z'_0$};
\node[state,above right of=0,accepting,label=south:\p{z_1, z_2}] (1) {$z'_1$};
\node[state,below right of=1,accepting,label=south:\p{z_2}] (2) {$z'_2$};
