...
\index{Deterministisch endlicher Automat (DEA)}\footcite[Seite 28]{theo:fs:1}}

Stellen Sie einen Automaten zu den folgenden Sprachen (\liAlphabet{a,b})
auf:
...
\item \liAusdruck[L_1]{x }{ x \text{ beinhaltet eine gerade Anzahl von } a}
...
\item \liAusdruck[L_2]{x }{ x \text{ beinhaltet eine ungerade Anzahl von } b}
