...
Bei der Minimierung suchen wir nun alle Zustandspaare, die zu einem
zusammengefasst werden können. Dafür erstellen wir uns zunächst eine
Zustandspaartabelle mit allen möglichen Zustandspaaren. Hierbei ist es
egal, ob die Zustände im Automaten verbunden sind oder nicht.

Da Zustände nicht mit sich selbst überprüft werden müssen, können wir
die Diagonale der Tabelle komplett streichen. Außerdem werden die Paare
nur in eine Richtung betrachtet, wir müssen die Paare (z1, z2) und (z2,
z1) also nicht als einzelne Paare sehen und können damit die obere
Hälfte der Tabelle über der Diagonalen (in der Abbildung rot markiert)
streichen.

Es werden die Zustandspaar markiert, in deinen ein Zustand ein
Endzustand  und der andere kein Endzustand ist.

Übergangstabelle

Als letztes werden die noch nicht markierten Zustandspaare auf alle
möglichen Übergangsmöglichkeiten überprüft. Entsteht hierbei ein bereits
gestrichenes Paar so wird das aktuell überprüfte Paar ebenfalls
gestrichen.
