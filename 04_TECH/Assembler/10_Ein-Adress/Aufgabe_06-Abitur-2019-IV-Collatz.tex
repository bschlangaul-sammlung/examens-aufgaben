...
\liPseudoUeberschrift{Ohne Modulo}

\liAssemblerDatei{Aufgabe_06-Abitur-2019-IV-Collatz-ohne-Modulo.mia}
...
\liAssemblerDatei{Aufgabe_06-Abitur-2019-IV-Collatz-mit-Modulo.mia}
...
\liMinispracheDatei{Aufgabe_06-Abitur-2019-IV-Collatz.mis}
...
\liJavaDatei[firstline=3]{aufgaben/tech_info/assembler/ein_adress/Collatz}
\end{liAntwort}
\end{enumerate}
\end{document}
