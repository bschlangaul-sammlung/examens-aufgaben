...
\begin{antwort}
\begin{liRmodell}
Kurs (\liPrimaer{KursNr}, Kursname)

Tutor (\liPrimaer{PersNr}, Name, Buero)
\end{liRmodell}
\end{antwort}
...
\begin{antwort}
\begin{liRmodell}
betreut (\liPrimaer{PersNr}, KursNr, Sprechstunde)

betreut (PersNr, \liPrimaer{KursNr}, Sprechstunde)

betreut (\liPrimaer{PersNr}, Kursname, Sprechstunde)

betreut (PersNr, \liPrimaer{Kursname}, Sprechstunde)

betreut (\liPrimaer{Name, Büro}, KursNr, Sprechstunde)

betreut (Name, Büro, \liPrimaer{KursNr}, Sprechstunde)

betreut (\liPrimaer{Name, Büro}, Kursname, Sprechstunde)

betreut (Name, Büro, \liPrimaer{Kursname}, Sprechstunde)
\end{liRmodell}
\end{antwort}
\end{enumerate}
