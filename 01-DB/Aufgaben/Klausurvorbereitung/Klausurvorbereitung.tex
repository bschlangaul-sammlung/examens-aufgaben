...
\InformatikPakete{mathe,syntax,er}
\usepackage[normalem]{ulem}
\begin{document}

\chapter{Aufgabenblatt 8: Klausurvorbereitung}

%-----------------------------------------------------------------------
%
%-----------------------------------------------------------------------

\section{Aufgabe 1: Wiederholung ER-Modell und Relationenmodell}
...
\section{Aufgabe 3: Staatsexamen Herbst 1996, Aufgabe 4}

Gegeben sei die folgende, in dritter Normalform vorliegende relationale
...
\item Formulieren Sie folgende Anfragen jeweils in relationaler Algebra
und SQL!
...
\begin{antwort}[muster]
\ueberschrift{Relationale Algebra}
...
Müsste richtig sein:
\ueberschrift{Relationale Algebra}
$\pi_{typ}(\sigma_{hersteller = \mlq vw \mrq}(Modelle
\bowtie_{Modelle.hnr = Hersteller.hnr} Hersteller))$
\end{antwort}
...
\item Formulieren Sie folgende SQL-Anfrage umgangssprachlich, aber exakt!
...
%
%-----------------------------------------------------------------------
\section{Aufgabe 5: Fertigungsdatenbank die Zweite (Fortsetzung Staatsexamen Herbst 1997)}
...
\section{Aufgabe 12: (Begriffe definieren) (aus Stex RS DB, Herbst 2015,
...
\section{Aufgabe 13: Personalverwaltung (Stex RS DB, Frühjahr 2012,
Thema Nr. 1, Teilaufgabe I, Aufgabe 3)}
