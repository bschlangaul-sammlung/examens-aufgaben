...
\section{Fibonacci-Zahlen\index{Mehr-Adress-Befehl-Assembler}}
...
\begin{liAntwort}
\liAssemblerDatei{Aufgabe_11-Fibonacci-rekursiv.mi}

\liJavaDatei[firstline=3]{aufgaben/tech_info/assembler/mehr_adress/FibonacciRekursiv}
\end{liAntwort}
