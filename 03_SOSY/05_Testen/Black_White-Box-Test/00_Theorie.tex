...
Mit dem Begriff Unit wird eine atomare Programmeinheit bezeichnet, die
groß genug ist, um als solche eigenständig getestet zu werden. Der
Unit-Test wird nicht selten auch als Modultest oder noch allgemeiner als
Komponententest bezeichnet. Wird die Methodik des Unit-Tests auf größere
Klassen- oder Modulverbünde angewendet, so geht der Testprozess fast
nahtlos in den Integrationstest über.\footcite[Seite 159 Kapitel 4.2.1.1
Unit Tests]{hoffmann:software}
