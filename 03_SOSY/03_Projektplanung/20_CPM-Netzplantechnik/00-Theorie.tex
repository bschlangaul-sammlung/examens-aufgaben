...
\begin{center}
\begin{tikzpicture}
\liCpmEreignisN(i){$i_k$}(0,0)
\liCpmEreignisN(j){$j_k$}(4,0)
...
\begin{center}
\begin{tikzpicture}
\liCpmEreignisN(1){$i_1$}(0,2)
\liCpmEreignisN(2){$i_2$}(0,0)

\liCpmEreignisN(m){}(2,1)

\liCpmEreignisN(3){$j_3$}(4,2)
\liCpmEreignisN(4){$j_4$}(4,0)
...
\begin{center}
\begin{tikzpicture}
\liCpmEreignisN(1){$i_1$}(0,1)
\liCpmEreignisN(2){$j_2$}(4,2)
\liCpmEreignisN(3){$j_3$}(4,0)

\liCpmVorgang(1>2){$e_1$}
\liCpmVorgang(1>3){$e_2$}
\liCpmScheinvorgang(2>3){$e_0$}
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\liCpmEreignisN(1){$i_1$}(0,4)
\liCpmEreignisN(2){$i_2$}(0,2)
\liCpmEreignisN(3){$i_3$}(0,0)

\liCpmEreignisN(4){$j_4$}(4,3)
\liCpmEreignisN(5){$j_5$}(4,0)

\liCpmEreignisN(m1){}(2,3)
\liCpmEreignisN(m2){}(2,0)
