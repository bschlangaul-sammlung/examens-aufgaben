...
(\liJavaCode{if (e == 1) { return b * 1; }}), womit verhindert wird,
...
\liJavaCode{function} an. Denken Sie dabei an die Angabe der
Zahlenbereiche!
...
\item Erklären Sie kurz, was die Methode \liJavaCode{function}
berechnet.
