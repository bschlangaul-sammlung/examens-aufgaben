...
\footcite[Thema 2, A6a]{examen:66115:2018:03}
}

\begin{enumerate}

\item Betrachten Sie die folgende Methode \java{m} in Java, die initial
mit \java{m(r, 0, r.length)} für das Array \java{r} aufgerufen wird.
Geben Sie dazu eine Rekursionsgleichung $T(n)$ an, welche die Anzahl an
Rechenschritten von \java{m} in Abhängigkeit von der Länge
\java{n = r.length} berechnet.
...
\section{Aufgabe 4: Komplexität\footcite{aud:ab:2}}
