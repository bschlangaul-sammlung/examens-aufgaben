...
\item Überlege dir, welche Konten Generalisierungen bzw.
Spezialisierungen anderer Konten sind. Warum ist es sinnvoll, eine
Klasse Konto als oberste Klasse Generalisierungshierarchie einzuführen?
...
\item Entwirf ein Klassendiagramm für die Klassen \java{Konto},
\java{Girokonto}, \java{Sparkonto}, \java{Geschaeftskonto}.
...
\item Implementiere die Klassen in einem eigenen Projekt und teste die
