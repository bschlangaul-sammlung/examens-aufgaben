...
Supermarkt und ändern Sie den Hintergund der Klasse \java{MyWorld} auf
das Bild supermarket-background, das Sie im Materialordner finden.
Passen Sie die Größe der Spielwelt in der Klasse \java{MyWorld} auf
600x566 an.
...
\begin{antwort}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/Akteur}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/BierWorld}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/Gegner}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/Kuh}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/Sepp}
\inputcode[firstline=3]{aufgaben/oomup/ab_3/bier/Traktor}
\end{antwort}
\end{enumerate}
\end{document}
