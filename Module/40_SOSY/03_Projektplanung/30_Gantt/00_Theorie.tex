...
zeitliche Abfolge von Aktivitäten graphisch in Form von \bEmph{Balken}
auf einer \bEmph{Zeitachse} darstellt.
...
\item Für das \bEmph{ganze Projekt} einen Start- und Endknoten
einzeichnen (falls gefordert bzw. nötig).

\item Für \bEmph{jede Aktivität} (= Balken im Gantt-Diagramm) einen
Start- und einen Endknoten einzeichnen.

\item Zwischen Start- und Endknoten einen \bEmph{Vorgang} einzeichnen.
...
\item Für jede \bEmph{Anordnungsbeziehung}, die im Gantt-Diagramm
vorkommt ist, einen \bEmph{Vorgang} einzeichnen. Ist der
\bEmph{zeitliche Versatz} zwischen dem Balken der Aktivität und dem der
Nachfolge-Aktivität
