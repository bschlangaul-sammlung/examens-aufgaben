...
\bEmph{Tätigkeits-Pfeil-Darstellung} oder CPM-Netzplantechnik (von
englisch \bEmph{critical path method}, CPM)
genannt.\footcite{wiki:methode-kritischer-pfad}

\section{Netzplantechnik, DIN 69900-1}

„Netzplantechnik umfasst \bEmph{alle Verfahren} zur Analyse,
Beschreibung, Planung, Steuerung und Überwachung von \bEmph{Abläufen}
auf der \bEmph{Grundlage der Graphentheorie}, wobei Zeit, Kosten,
...
Ein \bEmph{Vorgang} ist eine abgegrenzte Arbeitseinheit mit
\bEmph{Anfangs- und Endzeit} (vgl. Arbeitspaket im Projektmanagement).
Er besitzt eine \bEmph{Dauer}.
%
...
stattfinden.
%
In CPM Netzen werden Vorgänge als \bEmph{Pfeile zwischen Ereignissen}
dargestellt.
