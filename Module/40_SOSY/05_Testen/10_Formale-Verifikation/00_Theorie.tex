...
\bLadePakete{syntax,mathe,wpkalkuel}
\usepackage{array}
\usepackage{multicol}
\let\wp=\bWpKalkuel
...
\bEmph{mathematisch} zu beweisen.\footcite[Kapitel 6.1.3.1 Seite 178]{schneider}

Ein Algorithmus ist dabei

\begin{itemize}

\item \bEmph{partiell korrekt}, wenn er bei gültiger Eingabe
(Vorbedingung) \bEmph{immer ein gültiges Ergebnis} (Nachbedingung)
...
\item \bEmph{total korrekt}, wenn er partiell korrekt ist und
\bEmph{terminiert}.\footcite{wiki:korrektheit}
\end{itemize}
...
\bEmph{weakest precondition} (auf deutsch „schwächste Vorbedingung“).
...
sondern darum, eine \bEmph{allgemeingültige Aussage über das korrekte
Ablaufen} des Programms zu erhalten.

Die Überprüfung der Korrektheit geschieht durch \bEmph{Rückwärtsanalyse}
...
Alternativ kann auch der \bEmph{Hoare-Kalkül} benutzt werden, bei dem im
Gegensatz zum \text{wp}-Kalkül eine \bEmph{Vorwärtsanalyse} stattfindet.
...
Programmtext heißt \bEmph{Vorbedingung P}, eine Zusicherung danach
\bEmph{Nachbedingung Q}.\footcite{wiki:wp-kalkuel}
...
\bEmph{Schleifeninvariante}. Sie ist ein Prädikat für das
...
\begin{multicols}{2}
\bPseudoUeberschrift{1. Durchgang}
...
\bPseudoUeberschrift{2. Durchgang}
