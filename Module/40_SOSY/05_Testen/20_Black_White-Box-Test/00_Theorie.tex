...
Endknoten}. \memph{Verschiedenen Aussprungspunkte} (\zB mehrere
...
\memph{Kante} des Kontrollflussgraphen von mindestens einem Testfall
...
\memph{einmal wahr} und mindestens \memph{einmal falsch} wird. Da
hierdurch alle Knoten ebenfalls mindestens einmal besucht werden müssen,
ist die \memph{Anweisungsüberdeckung} in der Zweigüberdeckung
\memph{vollständig enthalten}.\footcite[Seite 209]{hoffmann:software}

Der Zweigüberdeckungstest wird auch
\memph{Entscheidungsüberdeckungstest} genannt, da die Hilfsvariable
...
White-Box-Prüftechnik, besitzt aufgrund ihrer \memph{immensen
Komplexität} aber nur eine äußerst \memph{geringe Praxisbedeutung}.
...
wenn für \memph{jeden möglichen Pfad}, der den Eingangsknoten des
...
Hilfe sich die \memph{kombinatorische Explosion} zumindest teilweise
eindämmen lässt. Von Bedeutung sind in diesem Zusammenhang insbesondere
die \memph{Boundary-Interior-Pfadüberdeckung} und die
\memph{strukturierte Pfadüberdeckung}.
...
Die Testfälle durchlaufen das Programm auf Pfaden, die den
\memph{Schleifenkörper betreten}, jedoch zu \memph{keiner Wiederholung}
führen. Innerhalb des Schleifeninneren müssen \memph{alle möglichen
...
Die Testfälle durchlaufen das Programm auf Pfaden, die den
Schleifenkörper betreten und \memph{mindestens eine weitere Iteration}
ausführen. Die Testfälle werden so gewählt, dass \memph{innerhalb der
...
Mit dem Begriff Unit wird eine \memph{atomare Programmeinheit}
bezeichnet, die groß genug ist, um als solche eigenständig getestet zu
werden. Der Unit-Test wird nicht selten auch als \memph{Modultest} oder
noch allgemeiner als \memph{Komponententest} bezeichnet. Wird die
