...
Der \bEmph{Auftraggeber} beschreibt im
\bEmph{Lastenheft}\footcite{wiki:lastenheft} möglichst präzise die
Gesamtheit der Anforderungen. (\bEmph{Was?})

Das \bEmph{Pflichtenheft}\footcite{wiki:pflichtenheft} beschreibt in
konkreter Form, wie der \bEmph{Auftragnehmer} die Anforderungen des
Auftraggebers zu lösen gedenkt. (\bEmph{Wie? Womit?})
