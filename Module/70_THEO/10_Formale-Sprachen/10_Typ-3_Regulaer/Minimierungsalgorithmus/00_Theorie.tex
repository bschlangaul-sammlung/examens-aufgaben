...
Wir erstellen eine \bEmph{Zustandspaartabelle} mit allen möglichen
Zustandspaaren. Dabei spielt es \bEmph{keine Rolle}, ob die
Zustände im Automaten \bEmph{verbunden sind oder nicht}.
...
\bEmph{Paare nur in einer Richtung} betrachtet. Die \bEmph{obere Hälfte}
der Tabelle über der Diagonalen \bEmph{kann gestrichen werden}.

Wir markieren die Zustandspaare, in denen ein Zustand \bEmph{ein
Endzustand und der andere kein Endzustand} ist.

Als letztes werden mit Hilfe einer \bEmph{Übergangstabelle} die noch
nicht markierten Zustandspaare auf alle möglichen Übergangsmöglichkeiten
überprüft. Entsteht hierbei ein \bEmph{bereits gestrichenes Paar} so
wird das aktuell überprüfte Paar \bEmph{ebenfalls gestrichen}.
