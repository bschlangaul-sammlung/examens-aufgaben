...
\begin{document}
\let\m=\liMenge
\liAufgabenTitel{„w^n^2“ „a^n b^m c^n“}
\section{Pumping-Lemma
\index{Pumping-Lemma (Reguläre Sprache)}
\footcite{theo:ab:1}}

Begründe jeweils, ob die folgenden Sprachen regulär sind oder nicht.
\liFussnoteUrl{https://www.uni-muenster.de/Informatik/u/lammers//EDU/ws08/AutomatenFormaleSprachen/Loesungen/Loesung05.pdf}
...
\liPseudoUeberschrift{Pumping-Lemma:}
...
\liPseudoUeberschrift{Begründung über die Zahlentheorie:}
...
\item \liAusdruck[L_3]{a^n b^m c^n}{m, n \in \mathbb{N}_0}

\begin{liAntwort}
\liAusdruck[L_3]{a^n b^m c^n}{m, n \in \mathbb{N}_0} ist nicht regulär.
...
\item \liAusdruck[L_4]{w \in \{a\}^*}{\mod_3(|w|) = 0}
