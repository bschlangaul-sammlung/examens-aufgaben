...
Ein deterministischer endlicher Automat (\bEmph{DEA}; englisch
deterministic finite state machine oder deterministic finite automaton,
\bEmph{DFA}) ist ein endlicher Automat, der unter \bEmph{Eingabe eines
Zeichens} seines Eingabealphabetes (den möglichen Eingaben) von einem
Zustand, in dem er sich befindet, in einen \bEmph{eindeutig bestimmten
...
Automaten sind \bEmph{deterministisch}, wenn es in jedem Zustand für
jedes Eingabesymbol \bEmph{höchstens einen Folgezustand} gibt.
...
dem es für den \bEmph{Zustandsübergang mehrere gleichwertige
