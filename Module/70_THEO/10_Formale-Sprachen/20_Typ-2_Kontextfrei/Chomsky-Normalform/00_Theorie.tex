...
\noindent
mit $A, B, C \in \mathbb{N}$ und $a \in \Sigma$. Ihre \memph{rechten}
Seiten bestehen also entweder aus \memph{genau zwei
Nichtterminalsymbolen} oder aus \memph{genau einem
