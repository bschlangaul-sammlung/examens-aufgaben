...
\bTuringMaschine{} ist gegeben durch:
...
Hierbei sind in der linken Spalte \bEmph{alle Zustände eingetragen, die
nicht Endzustände sind}, in der obersten Zeile \bEmph{alle Zeichen des
Bandalphabets}. Die \bEmph{Tabelleneinträge} selbst geben für den
betreffenden Zustand und das gerade gelesene Bandzeichen als
Arbeitsvorschrift das zu \bEmph{schreibende Zeichen}, die
\bEmph{Kopfbewegung} des Lese-/Schreibkopfs und den \bEmph{Folgezustand}
in Form eines Tripels an.
\bFussnoteUrl{https://info-wsf.de/turingmaschine/}
