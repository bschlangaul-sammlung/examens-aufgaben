...
Binärzahl verschmolzen. Die erzeugte Zahl heißt die \bEmph{Gödelnummer}
der Turing-Maschine $T$. Die Kodierung wird als \bEmph{Gödelisierung}
bezeichnet.
...
\bEmph{Abbildung} eine \bEmph{Beziehung (Relation) zwischen zwei
Mengen}, die jedem Element der einen Menge (Funktionsargument, Urbild,
...
(\emph{linkstotal})
\end{enumerate}
\bFussnoteUrl{https://files.ifi.uzh.ch/cl/siclemat/lehre/ws0607/ecl1/script/html/scriptse48.html}

\begin{bExkurs}[Totale Funktion]
...
klassischen \bEmph{Mathematik sind alle Funktionen total}. Der Begriff
der partiellen Funktion wurde in der theoretischen Informatik
eingeführt, um Programme zu beschreiben, die \bEmph{für gewisse
Eingabewerte nicht terminieren}.\footcite[Seite 51]{hoffmann}
...
\bFussnoteUrl{https://de.wikipedia.org/wiki/Partielle_Funktion}
...
vollständig auszuschöpfen, \dh jedes Element besitzt mindestens ein
Urbild in der Definitionsmenge.\footcite[Seite 51]{hoffmann}

Eine Surjektive Funktion ist eine Funktion, die jedes Element der
Zielmenge mindestens einmal als Funktionswert annimmt. Das heißt, jedes
Element der Zielmenge hat ein nichtleeres Urbild.
...
\begin{center}
\begin{tikzpicture}
\node[punkt,label=left:$a$] (a) at (0,4) {};
\node[punkt,label=left:$b$] (b) at (0,3) {};
\node[punkt,label=left:$c$] (c) at (0,2) {};

\node[punkt,label=right:$1$] (1) at (4,3.5) {};
\node[punkt,label=right:$2$] (2) at (4,2.5) {};

\node[menge,draw,fit= (a) (b) (c)] {} ;
\node[menge,fit= (1) (2)] {} ;
\draw[pfeil] (a) -- (1);
\draw[pfeil] (b) -- (1);
\draw[pfeil] (c) -- (2);
...
\node[punkt,label=right:$1$] (1) at (4,4.5) {};
\node[punkt,label=right:$2$] (2) at (4,3.5) {};
\node[punkt,label=right:$3$] (3) at (4,2.5) {};
\node[punkt,label=right:$4$] (4) at (4,1.5) {};

\node[menge,draw,fit= (a) (b) (c)] {} ;
\node[menge,fit= (1) (2) (3) (4)] {} ;
\draw[pfeil] (a) -- (3);
\draw[pfeil] (b) -- (2);
\draw[pfeil] (c) -- (1);
\end{tikzpicture}
...
\node[punkt,label=right:$1$] (1) at (4,4) {};
\node[punkt,label=right:$2$] (2) at (4,3) {};
\node[punkt,label=right:$3$] (3) at (4,2) {};
...
Als rekursiv aufzählbare Menge (auch \bEmph{semi-entscheidbare Menge})
wird eine \bEmph{Menge von natürlichen Zahlen} bezeichnet, wenn es einen
\bEmph{Algorithmus} gibt, der die Elemente dieser Menge
\bEmph{aufzählt}. Äquivalent ist diese Charakterisierung: Es gibt einen
