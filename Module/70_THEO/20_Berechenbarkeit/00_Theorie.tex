...
der Turing-Maschine $T$. Die Kodierung wird als \memph{Gödelisierung}
bezeichnet.
...
\memph{Abbildung} eine \memph{Beziehung (Relation) zwischen zwei
...
klassischen \memph{Mathematik sind alle Funktionen total}. Der Begriff
der partiellen Funktion wurde in der theoretischen Informatik
eingeführt, um Programme zu beschreiben, die \memph{für gewisse
...
Als rekursiv aufzählbare Menge (auch \memph{semi-entscheidbare Menge})
wird eine \memph{Menge von natürlichen Zahlen} bezeichnet, wenn es einen
\memph{Algorithmus} gibt, der die Elemente dieser Menge
\memph{aufzählt}. Äquivalent ist diese Charakterisierung: Es gibt einen
