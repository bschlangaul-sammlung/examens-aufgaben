...
\section{Fachdidaktische Ansätze}
...
\item Informationsorientierung\footcite[Forneck.1990, Seite 12]{ddi:fs:1}
\end{enumerate}
...
\section{Gender und Diversity}

Gender (soziales Geschlecht) meint Vorstellungen und Erwartungen, wie
Frauen und Männer angeblich sind (soziale Rollen in der Gesellschaft,
Rollenklischees - „typisch männlich“ - „typisch weiblich“).
Eigenschaftszuschreibungen an Männer und an Frauen sind historisch
geprägt und unterliegen dem gesellschaftlichen Wandel. Gender rückt
beide Geschlechter und die Geschlechterverhältnisse in den Blickpunkt,
wobei Frauen ebenso wenig wie Männer eine homogene Gruppe sind.

Diversity meint die soziale Vielfalt der Menschen: z. B. Gender,
ethnische Herkunft, Alter, Beeinträchtigungen, Sprachkenntnisse oder
kulturelles Wissen.\footcite[Seite 4]{ddi:fs:2}

\section{Konstruktivismus und Konstruktionismus}

Primat des Konstrukt\textbf{iv}ismus

\begin{enumerate}
\item Lernen ist nur über die aktive Beteiligung des
Lernenden möglich.

\item Lernen ist in jedem Fall konstruktiv: Ohne den individuellen
Erfahrungs- und Wissenshintergrund und eigene Interpretationen finden im
Prinzip keine kognitiven Prozesse statt.

\item Lernen erfolgt stets in spezifischen Kontexten, so dass jeder
Lernprozess auch als situativ gelten kann.

\item Lernen ist schließlich immer auch ein sozialer Prozess\footcite[Reinmann-Rothmeier.1996, Seite 5]{ddi:fs:2}
\end{enumerate}

\noindent
Konstrukt\textbf{ionsn}ismus

\begin{enumerate}
\item Der Ansatz basiert auf dem Verständnis des Konstruktivismus, das
Lernen als aktiven Aufbau von Wissensstrukturen begreift.

\item Wissen wird durch die Lernenden hergestellt, nicht von den
Lehrenden vermittelt.

\item Mit dem Konstruktionismus wird dies erweitert um die Vorstellung,
dass dieser Aufbau von Wissensstrukturen dann besonders gut gelingen
kann, wenn die Lernenden \memph{selbst etwas herstellen, konstruieren,}
ein äußerlich sichtbares, wahrnehmbares Objekt.\footcite[Schelhowe.2007,
Seite 5]{ddi:fs:2}
\end{enumerate}

\section{Formen der Repräsentation}

Bruner definiert in seinem EIS-Prinzip drei Formen der Repräsentation
von Wissen:

\begin{enumerate}
\item[Enaktive Repräsentation:]

Darstellung durch konkrete oder vorgestellte Handlungen

\item[Ikonische Repräsentation:]

Darstellung von Sachverhalten durch bildliche Formen

\item[Symbolische Repräsentation:]

Darstellung durch Zeichen und Sprache\footcite[Grevsmühl.2010]{ddi:fs:2}
\end{enumerate}
...
ideas! CS Unplugged is suitable for people of all ages, from elementary
school to seniors, and from many countries and backgrounds.
\footcite[https://classic.csunplugged.org, Seite 9]{ddi:fs:2}

%%
%
%%

\subsection{Unplugged Philosophie}

\begin{enumerate}
\item Demonstrating CS concepts, rather than programming
\item Kinaesthetic, generally on a large scale, involving team work
\item Fun and engaging, and not just busy work
\item Low cost
\item Under creative commons licence
\item Gender neutral (or at least, attractive to girls)
\item Cooperative approaches rather than individualistic ones
\item Story to capture interest and motivate children
\item Constructivistic
\item Reasonably error resilient\footcite[Bell.2009, Seite 10]{ddi:fs:2}
\end{enumerate}
...
In this book I have clearly been arguing that procedural thinking is a
powerful intellectual tool and even suggested analogizing oneself to a
computer as a strategy or doing it. … The cultural assimilation of the
computer presence will give rise to computer literacy. This phrase is
often taken as meaning knowing how to program, or knowing about the
varied uses made of computer. But true computer literacy is not just
knowing how to make use of computers and computational ideas. It is
knowing when it is appropriate to do so.
\footcite[Papert.1980, Seite 12]{ddi:fs:2}

Computational thinking is taking an approach to solving problems,
designing systems and understanding human behaviour that draws on
concepts fundamental to computing\footcite[Wing.2006, Seite 12]{ddi:fs:2}

%-----------------------------------------------------------------------
%
%-----------------------------------------------------------------------

\section{Modellieren in der Informatik}

Ein Modell ist eine \emph{abstrahierte Beschreibung} eines realen oder
geplanten \emph{Systems}, welche die für eine bestimmte \emph{Zielsetzung}
wesentlichen Eigenschaften des Systems
wiedergibt.\footcite[Hubwieser.2007, Seite 18]{ddi:fs:2}

%%
%
%%

\subsection{Phasen der Modellierung}

\begin{description}
\item[1. Abgrenzen:]

Identifikation der Grenzen

\item[2. Abstrahieren:]

Weglassen von nicht oder wenig bedeutsamen Details, Sonderfällen,
speziellen Ausprägungen,

\item[3. Idealisieren:]

Korrigieren kleiner Abweichungen von idealen Eigenschaften in Richtung
einer leichteren Beschreibung,

\item[4. Beschreiben:]

Anwendung spezieller Techniken zur Darstellung der wesentlichen
Eigenschaften des zu beschreibenden Systems\footcite[Seite 18]{ddi:fs:2}
\end{description}
