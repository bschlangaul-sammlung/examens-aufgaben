...
\bLadePakete{syntax,mathe,formale-sprachen}
...
\bEmph{Ressourcenverbrauch} (Laufzeit und Resourcenverbrauch) eines
...
\noindent
Die Algorithmische Komplexität beschreibt die \bEmph{Effizienz} eines
eingesetzten Algorithmus und entscheidet über die \bEmph{praktische
...
Der günstigste Fall (\bEmph{best case}) für einen Algorithmus liegt vor,
wenn sein Ergebnis mit minimalem Aufwand erzielt werden kann.

Es handelt sich um den ungünstigsten Fall (\bEmph{worst case}), wenn der
Aufwand zur Erzielung des Ergebnisses maximal ist.

Im Durchschnittsfall (\bEmph{average case}) ist ein mittlerer erwarteter
...
\end{bExkurs}
\begin{bExkurs}[asymptotische Abschätzung]%
