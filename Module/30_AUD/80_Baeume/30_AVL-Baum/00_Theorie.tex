...
\noindent
Ein AVL-Baum ist ein binärer Suchbaum, der \bEmph{höhenbalanciert} ist,
...
\noindent
Die \bEmph{„Entartung“} des Baums wird so vermieden. Die Höhe eines
AVL-Baums ist $h \in \mathcal{O}(\log n)$. Beim Einfügen und Löschen von
Knoten muss die AVL-Eigenschaft durch \bEmph{Rotationen}
...
\bEmph{Löschalgorithmus der binären Suchbäume} angewendet. Wie beim
Einfügen in AVL-Bäumen muss der Suchbaum nun gegebenenfalls
\bEmph{rebalanciert} werden. Dazu wird der Weg vom Elternknoten des
