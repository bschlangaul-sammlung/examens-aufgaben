...
Daten werden in der Regel in den Knoten gespeichert. Die \memph{Wurzel}
eines Baums besitzt \memph{nur auslaufende Kanten}. \memph{Blätter} sind
\memph{Knoten mit nur einer einlaufenden Kante}.
...
Ein Binärbaum ist ein Baum, bei dem \memph{jeder Knoten genau zwei
