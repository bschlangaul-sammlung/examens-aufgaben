...
\bLadePakete{mathe,tabelle,syntax,uml,baum}
...
\emph{„Schlüssel“} tragen, und die Schlüssel des \bEmph{linken
Teilbaums} eines Knotens nur \bEmph{kleiner (oder gleich)} und die des
\bEmph{rechten} Teilbaums nur \bEmph{größer}\footcite[Seite 5]{aud:fs:5}
...
\bJavaDatei[firstline=46,lastline=52]{baum/BinaerBaum}
...
\bJavaDatei[firstline=78,lastline=84]{baum/BinaerBaum}
...
\bJavaDatei[firstline=97,lastline=107]{baum/BinaerBaum}
...
\begin{enumerate}
\item Der Knoten ist ein \bEmph{Blatt}. Dieser Fall ist der einfachste,
da hier nur der Elternknoten zu bestimmen ist und dessen Verweis auf den
Knoten entfernt werden muss.

\item Der Knoten besitzt nur \bEmph{einen Kindknoten}. In diesem Fall
ist der Verweis vom Elternknoten auf den Kindknoten des zulöschenden
Knotens umzulenken.

\item Der Knoten ist ein innerer Knoten mit \bEmph{zwei Kindknoten}.
Hierbei muss der Knoten durch den am \bEmph{weitesten links stehenden
Knoten des rechten Teilbaumes ersetzt} werden, da dieser in der
