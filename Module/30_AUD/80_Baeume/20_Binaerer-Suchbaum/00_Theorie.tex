...
\liJavaDatei[firstline=62,lastline=68]{baum/BinaerBaum}
...
\liJavaDatei[firstline=46,lastline=52]{baum/BinaerBaum}
...
\liJavaDatei[firstline=78,lastline=84]{baum/BinaerBaum}
...
\liJavaDatei[firstline=97,lastline=107]{baum/BinaerBaum}
...
Hierbei muss der Knoten durch den am \memph{weitesten links stehenden
