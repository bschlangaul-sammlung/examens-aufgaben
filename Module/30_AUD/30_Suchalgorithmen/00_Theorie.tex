...
%
Das \bEmph{Suchen in sortierten Daten} ist sinnvoll, denn es kann
optimiert werden.
...
Es wird eine Folge vom \bEmph{ersten Element} an durchlaufen. Die Suche
ist beendet, wenn das gesuchte Element gefunden ist oder die
\bEmph{gesamte Folge} ohne Ergebnis durchlaufen wurde.
