...
\begin{liAntwort}
\liJavaDatei[firstline=4,lastline=21]{aufgaben/aud/muster/backtracking/RekursivesBacktracking}
...
\liJavaDatei{aufgaben/aud/muster/backtracking/RekursivesBacktracking}
