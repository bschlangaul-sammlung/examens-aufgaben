...
\begin{liAntwort}
\liJavaDatei[firstline=43,lastline=57]{aufgaben/aud/muster/dp/Gitter}
\end{liAntwort}

\begin{liAdditum}
\liPseudoUeberschrift{Die komplette Java-Klasse}
\liJavaDatei{aufgaben/aud/muster/dp/Gitter}

%%
%
%%

\liPseudoUeberschrift{Text-Ausgabe}
...
\liJavaTestDatei{aufgaben/aud/muster/dp/GitterTest}
\end{liAdditum}
