...
Bei \bEmph{internen Sortierverfahren} ist stets ein \bEmph{direkter
Zugriff} auf \bEmph{alle} zu sortierenden Elemente notwendig. Alle
Elemente müssen \emph{gleichzeitig} im Hauptspeicher liegen.

Bei \bEmph{externen Sortierverfahren} ist der Zugriff auf einen
\bEmph{Teil} der zu sortierenden Elemente beschränkt. Nur ein Teil der
Daten muss gleichzeitig im \emph{Hauptspeicher} liegen. Dieses Verfahren
eignet sich für Sortierung von \bEmph{Massendaten} auf \bEmph{externen
...
Beim vergleichsbasierten Sortieren \bEmph{vergleicht} der Algorithmus
mehrfach jeweils \bEmph{zwei Elemente} miteinander. Die Elementen werden
...
\bEmph{keinen direkten Vergleich} zwischen zwei Elementen, er
\bEmph{zählt} stattdessen die Werte oder betrachtet \bEmph{„einzelne
