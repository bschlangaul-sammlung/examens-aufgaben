...
\bJavaDatei[firstline=11,lastline=22]{sortier/InsertionMinimal}
...
\bJavaDatei[firstline=9,lastline=32]{sortier/InsertionIterativ}
...
\bJavaDatei[firstline=10,lastline=40]{sortier/InsertionRekursiv}
