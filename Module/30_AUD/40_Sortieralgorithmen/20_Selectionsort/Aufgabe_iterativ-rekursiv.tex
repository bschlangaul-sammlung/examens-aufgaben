...
\liAufgabenMetadaten{
  ...
  Stichwoerter = {Selectionsort, Iterative Realisation, Rekursion},
}
...
\liJavaCode{selectionSortIterativ()} und
\liJavaCode{selectionSortRekursiv()}. Eine \liJavaCode{swap}-Methode,
...
\liJavaDatei[firstline=11,lastline=21]{aufgaben/aud/sortier/SelectionSort}

\liPseudoUeberschrift{rekursiv}

\liJavaDatei[firstline=23,lastline=35]{aufgaben/aud/sortier/SelectionSort}
\end{liAntwort}
