...
Es wird als Vorbedingung vorausgesetzt, dass die Methode \liJavaCode{sum}
nur für Werte $n \geq 0$ aufgerufen wird.

\liJavaDatei[firstline=8,lastline=14]{aufgaben/aud/induktion/Gauss}

\noindent
Beweisen Sie mittels vollständiger Induktion, dass der Methodenaufruf
\liJavaCode{sum(n)} die Summe der ersten $n$ aufeinanderfolgenden
...
\liJavaTestDatei{aufgaben/aud/induktion/GaussTest}
