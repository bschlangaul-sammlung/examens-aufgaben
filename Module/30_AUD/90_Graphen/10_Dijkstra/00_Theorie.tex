...
\bLadePakete{syntax,mathe,graph}
\usepackage{blkarray}
...
\noindent
Der Algorithmus von Dijkstra bestimmt den \bEmph{kürzesten Pfad}
zwischen einem Startknoten und einem oder mehreren Zielknoten in einem
gewichteten Graphen.
%
Es handelt sich um einen \bEmph{gierigen} Algorithmus: in jedem Schritt
wird der am nächsten gelegene Knoten besucht. Der untersuchte Graph kann
\bEmph{gerichtet oder ungerichtet} sein. Die \bEmph{Kantengewichte}
müssen jedoch \bEmph{alle positiv} sein.
...
\bJavaDatei[firstline=15]{graph/algorithmen/KuerzesterPfadDijkstra}
