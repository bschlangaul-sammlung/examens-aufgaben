...
\bEmph{Prozedur}, \bEmph{Funktion} oder \bEmph{Methode} in einem
Computerprogramm \bEmph{selbst wieder auf} (d. h. enthält eine
Rekursion). Auch der gegenseitige Aufruf stellt eine Rekursion dar.

Wichtig bei der rekursiven Programmierung ist eine
\bEmph{Abbruchbedingung} in dieser Funktion, weil sich das rekursive
