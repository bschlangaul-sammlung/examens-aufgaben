...
\item Erstellen Sie eine neue Klasse \liJavaCode{ArrayInvertierer} mit
...
\item Implementieren Sie dann eine \liJavaCode{main}-Methode, in der Sie
zwei verschieden lange \liJavaCode{String}-Arrays erzeugen und die
...
[optional] Wenn das ursprüngliche \liJavaCode{String}-Array selbst
