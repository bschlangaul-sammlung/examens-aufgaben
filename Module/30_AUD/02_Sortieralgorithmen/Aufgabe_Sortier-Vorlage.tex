...
\liLadePakete{spalten,syntax}
\begin{document}
\liAufgabenTitel{Sortier-Vorlage}

\section{Aufgabe 2: Sortieren\footcite[Aufgabenblatt 2: Rekursion,
...
dem Beiblatt genauer erklärt wird.
...
\liJavaCode{selectionSort()}.\index{Selectionsort}

\begin{liAntwort}
\liJavaDatei[firstline=75,lastline=105]{aufgaben/aud/ab_2/Sortieralgorithmen}
\end{liAntwort}
...
\item Vervollständige die Methode
\liJavaCode{bubbleSort()}.\index{Bubblesort}

\begin{liAntwort}
\liJavaDatei[firstline=107,lastline=136]{aufgaben/aud/ab_2/Sortieralgorithmen}
\end{liAntwort}
\end{enumerate}
\end{document}
