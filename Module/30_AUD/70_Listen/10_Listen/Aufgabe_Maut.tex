...
\liUmlLeserichtung[pos=below,dir=right,distance=0cm]{erster}
...
\liUmlLeserichtung[pos=right,dir=left,distance=1cm]{enthält}
...
\liUmlLeserichtung[pos=above right,dir=left,distance=1cm and 1cm]{nächster}
