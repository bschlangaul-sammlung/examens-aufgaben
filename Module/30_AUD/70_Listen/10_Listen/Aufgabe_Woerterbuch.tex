...
\item Mit der Methode \liJavaCode{einfuegen (String deutsch, String
...
Methode \liJavaCode{compareTo()} in Java funktioniert!

\item Der Aufruf der Methode \liJavaCode{uebersetze(String deutsch)} auf
...
\liPseudoUeberschrift{Klasse \texttt{WörterbuchEintrag}}

\noindent
Die abstrakte Klasse im Kompositumentwurfsmuster von der sowohl die
primitive Klasse als auch die Behälterklasse erben.

\liJavaDatei[firstline=3]{aufgaben/aud/listen/woerterbuch/WoerterbuchEintrag}

\liPseudoUeberschrift{Klasse \texttt{WortPaar}}

\noindent
Das Listenelement (die primitive Klasse im Kompositumentwurfsmuster).

\liJavaDatei[firstline=3]{aufgaben/aud/listen/woerterbuch/WortPaar}

\liPseudoUeberschrift{Klasse \texttt{Wörterbuch}}

\noindent
Die Behälterklasse im Kompositumentwurfsmuster.

\liJavaDatei[firstline=6]{aufgaben/aud/listen/woerterbuch/Woerterbuch}

\liPseudoUeberschrift{Test}

\liJavaTestDatei{aufgaben/aud/listen/woerterbuch/WoerterbuchTest}
