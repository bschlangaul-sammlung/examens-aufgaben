...
\begin{document}
\bAufgabenTitel{Kleintierpraxis}
...
\bJavaDatei[firstline=3,lastline=6]{aufgaben/oomup/ab_5/Kleintier}
\bJavaDatei[firstline=10,lastline=13]{aufgaben/oomup/ab_5/Kleintier}

\bPseudoUeberschrift{Klasse \emph{Hund}}
\bJavaDatei[firstline=3,lastline=8]{aufgaben/oomup/ab_5/Hund}

\bPseudoUeberschrift{Klasse \emph{Katze}}
\bJavaDatei[firstline=3,lastline=9]{aufgaben/oomup/ab_5/Katze}

\bPseudoUeberschrift{Klasse \emph{Heimtier}}
\bJavaDatei[firstline=3,lastline=9]{aufgaben/oomup/ab_5/Heimtier}
...
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_5/Hund}
...
\bJavaDatei[firstline=12,lastline=20]{aufgaben/oomup/ab_5/Hund}
\end{liAntwort}
\end{enumerate}
