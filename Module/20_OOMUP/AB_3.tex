...
Supermarkt und ändern Sie den Hintergund der Klasse \bJavaCode{MyWorld} auf
das Bild supermarket-background, das Sie im Materialordner finden.
Passen Sie die Größe der Spielwelt in der Klasse \bJavaCode{MyWorld} auf
600x566 an.
...
\begin{bAntwort}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/Akteur}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/BierWorld}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/Gegner}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/Kuh}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/Sepp}
\bJavaDatei[firstline=3]{aufgaben/oomup/ab_3/bier/Traktor}
\end{bAntwort}
\end{enumerate}
\end{document}
