...
Linie getrennt.
\bLatexCode{\umlclass{Name}{Attribute}{Methoden}}
...
\bLatexCode{\umlsimpleclass[type=abstract]{Name}}
\bLatexCode{\umlsimpleclass[tags=abstract]{Name}}
\bLatexCode{\umlsimpleclass[type=abstrakt]{Name}}
...
Klassenattribute (statische Attribute) werden unterstrichen \bLatexCode{\umlstatic{- gehalt}}
...
\bLatexCode{\umlcompo[mult1=1,mult2=1..*]{A}{B}}
...
\bLatexCode{\umlassoc[arg1=faecher,arg2=lehrer]{Fach}{Lehrer}}
...
\bLatexCode{
  \umlassoc[name=unterrichtet]{Fach}{Lehrer}
  \bUmlLeserichtung[pos=below,dir=right,distance=0cm]{unterrichtet}
}
...
Multiplizitäten vermerkt. \bLatexCode{\umlassoc[mult1=1..*,mult2=1]{Fach}{Lehrer}}
...
ausgefüllten Dreieck als Pfeilspitze. \bLatexCode{\umlreal{A}{B}}
...
abhängigen auf das unabhängige} Modellelement. \bLatexCode{\umldep{A}{B}}
...
\bLatexCode{\umldep[stereo=use]{A}{B}}
...
\begin{description}
\item[Unspezifizierte Navigierbarkeit] \bLatexCode{\umlassoc{A}{B}}
...
\item[Unidirektionale Navigierbarkeit] \bLatexCode{\umluniassoc{A}{B}}
