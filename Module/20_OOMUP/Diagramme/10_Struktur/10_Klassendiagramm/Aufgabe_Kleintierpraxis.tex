...
\liJavaDatei[firstline=3,lastline=6]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Kleintier}
\liJavaDatei[firstline=10,lastline=13]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Kleintier}

\liPseudoUeberschrift{Klasse \emph{Hund}}
\liJavaDatei[firstline=3,lastline=8]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Hund}

\liPseudoUeberschrift{Klasse \emph{Katze}}
\liJavaDatei[firstline=3,lastline=9]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Katze}

\liPseudoUeberschrift{Klasse \emph{Heimtier}}
\liJavaDatei[firstline=3,lastline=9]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Heimtier}
\end{liAntwort}
...
\liJavaDatei[firstline=3]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Hund}
...
\liJavaDatei[firstline=12,lastline=20]{aufgaben/oomup/klassendiagramm/kleintierpraxis/Hund}
\end{liAntwort}
\end{enumerate}
