...
\bLadePakete{uml}
\begin{document}
\bAufgabenTitel{Universitätsverwaltung}
...
\umlassoc[arg1=adresse,arg2=person,stereo=wohnt\bLeserichtungRechts,mult1=0..1,mult2=1,pos1=0.15,pos2=0.85]{Person}{Wohnadresse}
\end{tikzpicture}
\end{document}
