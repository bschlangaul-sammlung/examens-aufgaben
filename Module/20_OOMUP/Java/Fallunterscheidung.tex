...
entscheidet über die Wertzuweisung. Ist er \bJavaCode{true}, so wird der Wert
...
\bJavaCode{switch}-Anweisung.

\bigskip
\noindent
\textbf{Hinweis:} Die switch-Anweisung funktioniert \bEmph{nur} mit
\bEmph{ganzen Zahlen} oder \bEmph{Buchstaben}, nicht aber mir reellen
Zahlen oder Strings.

\bigskip
\noindent
\textbf{Beispiel:} Die Schulnote eines Schülers wird in der Variable
\bJavaCode{note} gespeichert. Geben Sie mit Hilfe der \bJavaCode{switch}-Anweisung
