...
erstellt werden können, \dh die Klasse ist nicht \bEmph{nicht
instanziierbar}.
...
dazu werden abstrakte \bEmph{Methoden} verwendet. Diese \bEmph{müssen}
dann in der \bEmph{Unterklasse implementiert} werden.
