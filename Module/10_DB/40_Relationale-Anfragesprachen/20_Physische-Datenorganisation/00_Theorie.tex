...
Änderungen an der \bEmph{physischen} Speicher- oder der Zugriffsstruktur
(beispielsweise durch das Anlegen einer Indexstruktur) haben keine
Auswirkungen auf die \bEmph{logische} Struktur der Datenbasis, also auf
das Datenbankschema.
...
Benutzersichten bereit, wie beispielsweise \bEmph{Formulare}, \bEmph{Masken-Layouts},
\bEmph{Schnittstellen}.

\item[Konzeptionelle / logische Ebene]

Die konzeptionelle Ebene beschriebt, \bEmph{welche Daten} in der
Datenbank \bEmph{gespeichert} sind, sowie \bEmph{deren Beziehungen.}
Ziel des Datenbankdesigns ist eine vollständige und redundanzfreie
\bEmph{Darstellung aller zu speichernden Informationen}. Hier findet die
...
dar. Sie beschreibt, \bEmph{wie und wo die Daten in der Datenbank
