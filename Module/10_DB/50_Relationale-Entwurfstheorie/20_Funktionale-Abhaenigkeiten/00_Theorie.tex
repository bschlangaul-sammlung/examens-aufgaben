...
gelten, \bEmph{weitere funktionale Abhängigkeiten ableiten}.
...
\bPseudoUeberschrift{Axiome von Armstrong}
...
Die Armstrong-Axiome sind \bEmph{korrekt} und \bEmph{vollständig}: Diese
...
\bPseudoUeberschrift{Abgeleitete Regeln}
