...
\bLadePakete{mathe,normalformen}
\usepackage{tabularx}
\usepackage{paralist}
...
Sei $R$ ein Relationenschema. Ein Attribut $A \in R$ heißt \bEmph{prim},
falls $A$ Teil eines Schlüsselkandidaten von $R$ ist. Andernfalls heißt
A \bEmph{nichtprim}.\footcite[Seite 191]{winter}

\begin{liExkurs}[Normalformen]
\begin{description}
...
\begin{liExkurs}[Bestimmung der Attributhülle]
\begin{flalign*}
\textit{Hülle}(F,\alpha )\\
    \alpha^{+}=\alpha\\
...
anderen Attribute in einer Relation durch die \bEmph{gegebenen}
...
alle Attribute \bEmph{atomar} sind.

\bPseudoUeberschrift{1NF verletzt}

\FA{CDID -> Album, Gründungsjahr, Erscheinungsjahr, Titelliste;}

\bPseudoUeberschrift{in 1NF}
...
Normalform vorliegt und \bEmph{kein Nichtprimärattribut} (Attribut, das
nicht Teil eines Schlüsselkandidaten ist) funktional von einer
\bEmph{echten Teilmenge eines Schlüsselkandidaten abhängt}.
...
\bPseudoUeberschrift{2NF verletzt}
...
von einem Schlüsselkandidaten \bEmph{transitiv abhängt.}\footcite[Dritte
Normalform (3NF)]{wiki:normalisierung}

\bPseudoUeberschrift{3NF verletzt}
...
\bPseudoUeberschrift{BCNF verletzt}
