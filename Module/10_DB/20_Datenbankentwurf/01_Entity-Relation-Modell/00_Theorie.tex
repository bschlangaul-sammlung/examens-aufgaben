...
Die Generalisierung ist eine \bEmph{Abstraktion auf Ebene der
Entitytypen}, um eine bessere Strukturierung zu erzielen.
%
Die \bEmph{Eigenschaften ähnlicher Entitytypen} werden einem
\bEmph{gemeinsamen Obertyp} zugeordnet. Die Eigenschaften (Attribute),
die nicht von den generalisierten Entitytypen geteilt werden, verbleiben
in den Untertypen. Der \bEmph{Untertyp stellt somit Spezialisierung} des
Obertyps dar.
%
Der \bEmph{Untertyp erbt alle Eigenschaften} des Obertyps. Die
Entitymenge des Untertyps ist eine Teilmenge der Entitymenge des
Obertyps.
%
Man spricht von einer \bEmph{disjunkten Spezialisierung}, wenn eine
Entity nur Mitglied von einer der Untertypen ist und es keine
Überschneidungen gibt.
%
\bEmph{Vollständige Spezialisierung} nennt man die Modellierung, wenn es
...
Gezeichnet wird die Generalisierung meist durch ein \bEmph{Dreieck}.
In manchen Diagrammen stellt ein nach \bEmph{oben} zeigendes Dreieck die
\bEmph{Generalisierung}, ein nach unten gerichtetes Dreieick die
\bEmph{Spezialisierung} dar.
...
einem \bEmph{anderen Entitytyp abhängig} ist und oft \bEmph{nur in
Kombination} mit dem Schlüssel des \bEmph{übergeordneten Entitytyps}
eindeutig identifiziert werden kann.

Eine \bEmph{Totale Teilnahme} (auch \emph{totale Partizipation} oder
