...
Unter einer Transaktion versteht man die \bEmph{„Bündelung“ mehrerer
Datenbankoperationen}, die in einem Mehrbenutzersystem ohne unerwünschte
Einflüsse durch andere Transaktionen als \bEmph{Einheit fehlerfrei
ausgeführt} werden sollen.\footcite[Seite 1]{db:fs:5}
...
Dieser Befehl führt zu einem \bEmph{Selbstabbruch} der Transaktion. Das
...
\bEmph{rückgängig gemacht werden}. Diesen Vorgang nennt man
\bEmph{Rollback}. Dazu müssen gegebenenfalls die zuletzt gültigen Werte
...
geführter Transaktionen tatsächlich \bEmph{permanent} gemacht werden.
Dazu müssen gegebenenfalls die \bEmph{neuen Werte der Datenbankobjekte
erneut} auf die Datenbank geschrieben werden.\footcite[Seite
11]{db:fs:5}
...
\bEmph{Änderungen} in einer Datenbank, die durch eine Transaktion
...
wird \bEmph{gelesen}.\footcite[11.1.2 Abhängigkeit von nicht freigegebenen Änderungen, Seite 332]{kemper}
...
\bEmph{zweimal gelesen}, wobei dieser Wert aber in der Zwischenzeit von
einer anderen Transaktion \bEmph{geändert} wurde.\footcite[11.1.3 Phantomproblem, Seite 333]{kemper}
