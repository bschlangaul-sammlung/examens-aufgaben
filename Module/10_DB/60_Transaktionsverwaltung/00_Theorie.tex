...
\memph{rückgängig gemacht werden}. Diesen Vorgang nennt man
\memph{Rollback}. Dazu müssen gegebenenfalls die zuletzt gültigen Werte
...
geführter Transaktionen tatsächlich \memph{permanent} gemacht werden.
Dazu müssen gegebenenfalls die \memph{neuen Werte der Datenbankobjekte
...
\memph{Änderungen} in einer Datenbank, die durch eine Transaktion
...
wird \memph{gelesen}.\footcite[11.1.2 Abhängigkeit von nicht freigegebenen Änderungen, Seite 332]{kemper}
...
\memph{zweimal gelesen}, wobei dieser Wert aber in der Zwischenzeit von
einer anderen Transaktion \memph{geändert} wurde.\footcite[11.1.3 Phantomproblem, Seite 333]{kemper}
