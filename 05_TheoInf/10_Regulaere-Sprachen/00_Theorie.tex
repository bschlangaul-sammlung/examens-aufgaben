...
\footcite[Seite 63-64]{theoinf:fs:1}
...
\section{Äquivalenzklassen (nach Myhill, Nerode)\footcite{theoinf:fs:}}
...
erkennt. (Darauf fußt Minimalisierungsalgorithmus.)

\subsection{Beispiel zu Äquivalenzklassen}

$(1|11|111)0^*$ sind alle Binärzahlen, die mit einer, zwei oder drei Einsen
beginnen, gefolgt von beliebig vielen Nullen.
...
\section{Potenzmengenalgorithmus NEA $\rightarrow$ DEA\footcite[Seite 35-48]{theoinf:fs:1}}
