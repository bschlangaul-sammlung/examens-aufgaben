...
\liLadePakete{sql,mathe,rmodell}
\begin{document}
\liAufgabenMetadaten{
  Titel = {Aufgabe 2},
  Thematik = {Polizei},
  ...
  ZitatBeschreibung = {Thema 1 Teilaufgabe 1 Aufgabe 2},
...
\begin{liRmodell}
\liRelationMenge{Polizist}{\liPrimaer{PersNr}, DSID, Vorname, Nachname, Dienstgrad, Gehalt}
\liRelationMenge{Dienststelle}{\liPrimaer{DSID}, Name, Strasse, HausNr, Stadt}
\liRelationMenge{Fall}{\liPrimaer{AkZ}, Titel, Beschreibung, Status}
\liRelationMenge{Arbeitet\_An}{\liPrimaer{PersNr}, AkZ, Von, Bis}
\liRelationMenge{Vorgesetzte}{\liPrimaer{PersNr}, PersNr, Vorgesetzter}
\end{liRmodell}
...
\liPseudoUeberschrift{Lösungsansatz 1}
...
\liPseudoUeberschrift{Lösungsansatz 2}
