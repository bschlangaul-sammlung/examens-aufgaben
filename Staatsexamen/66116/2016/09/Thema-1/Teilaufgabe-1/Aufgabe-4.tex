...
\begin{liRmodell}
\liRelationMenge{Mitarbeiter}{
\liPrimaer{MitarbeiterID}, Vorname, Nachname, \liFremd{Vorgesetzter[Mitarbeiter]}, \liFremd{AbteilungsID[Abteilung]}, Telefonnummer, Gehalt}

\liRelationMenge{Abteilung}{\liPrimaer{AbteilungsID}, Bezeichnung}
\end{liRmodell}
