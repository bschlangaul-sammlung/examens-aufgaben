...
\begin{document}
\liAufgabenTitel{PKI-System Lehrer Schüler}
...
auch direkt (z.\,B. per E-Mail oder USB-Stick) an den Schüler
übermitteln.

Der Schüler kann nun seine Nachricht (z.\,B. seine Lösung) mit dem ÖS
...
beliebige Informationen (z.\,B. die Note) „digital signieren“. Diese
...
\begin{liAntwort}
\liPseudoUeberschrift{Interface „IMap“}
\liJavaDatei[firstline=3]{examen/examen_66116_2016_09/pki/IMap}

\liPseudoUeberschrift{Klasse „MapImpl“}
\liJavaDatei[firstline=3]{examen/examen_66116_2016_09/pki/MapImpl}

\liPseudoUeberschrift{Klasse „MapEntry“}
\liJavaDatei[firstline=3]{examen/examen_66116_2016_09/pki/MapEntry}
\end{liAntwort}
