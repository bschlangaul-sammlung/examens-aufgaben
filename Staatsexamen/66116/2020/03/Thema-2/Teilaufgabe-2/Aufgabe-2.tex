...
\liLadePakete{syntax,rmodell,relationale-algebra}
\begin{document}
\liAufgabenMetadaten{
  Titel = {Aufgabe 2},
...
kann, dass keine Kollektion den Anforderungen \liSqlCode{k.Jahr = 2018}
oder \liSqlCode{HAVING COUNT(...)} genügt. Die maximale Anzahl an Tupeln
