...
\path (S) -- (2);
\path (2) -- (3);
\path[wahr] (3) -- (4) \bedingung{right}{wort != null};
\path[falsch] (3) -- (22)  \bedingung{left}{wort == null};
\path (4) -- (5);
\path[wahr] (5) -- (6) \bedingung{right}{laenge >= 2};
\path[falsch] (5) -- (17) \bedingung{left,rotate=70}{laenge < 2};
\path (6) -- (7);
\path (7) -- (8);
\path (8) -- (10);
\path[wahr] (10) -- (12) \bedingung{right}{c != c};
\path[falsch] (10) -- (7) \bedingung{left,rotate=70,pos=0.8}{c == c};
\path (12) -- (22);
\path (17) -- (18);
\path (18) -- (22);
\path (22) -- (E);
