...
\begin{itemize}
\item Schreiben Sie ein Interface\index{Interface} \java{Person} sowie
zwei davon erbende Interfaces \java{Angestellter} und \java{Kunde}. Die
...
\java{PersonImpl}, die das Interface \java{Person} implementiert. Für
