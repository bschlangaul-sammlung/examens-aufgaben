...
\path (S) -- (1);
\path[falsch] (1) -- (2) \liBedingungFalsch{right};
\path (2) -- (3);
\path[falsch] (3) -- (4) \liBedingungFalsch{below};
\path (3) -- (5) \liBedingungWahr{right};
\path[falsch] (5) -- (6) \liBedingungFalsch{right};
\path (5) -- (7) \liBedingungWahr{right};
\path (6) -- (8) \liBedingungWahr{right};
\path (7) -- (8);
\path[falsch] (6) -- (E) \liBedingungFalsch{right};
\path (4) -- (E);
\path (1) -- (-2,1) -- (E) \liBedingungWahr{left};
\path (8) -- (2,6) -- (2,3) -- (3);
...
\path (S) -- (1);
\path[falsch] (1) -- node[name=12]{} (2);
\path (2) -- (3);
\path[falsch] (3) -- node[name=34]{} (4);
\path (3) -- node[name=35]{} (5);
\path[falsch] (5) -- node[name=56]{} (6);
\path (5) -- node[name=57]{} (7);
\path (6) -- node[name=68]{} (8);
\path (7) -- (8);
\path[falsch] (6) -- node[name=6E]{} (E);
\path (4) -- (E);
\path (1) -- node[name=1E]{} (-2,1) -- (E);
