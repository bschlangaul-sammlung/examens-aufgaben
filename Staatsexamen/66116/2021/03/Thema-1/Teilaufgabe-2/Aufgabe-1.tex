...
\end{description}
\liFussnoteUrl{https://www.dbs.ifi.lmu.de/Lehre/DBSII/SS2015/vorlesung/DBS2-03-Synchronisation.pdf}
\end{liAntwort}
...
\end{itemize}
\liFussnoteUrl{https://de.wikipedia.org/wiki/Data-Dictionary}
\end{liAntwort}
