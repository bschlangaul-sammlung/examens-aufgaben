...
\liJavaCode{Fahrzeug}, deren Instanzen folgende Eigenschaften besitzen (wählen
Sie geeignete Typen):
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/aud/ab_1/parkhaus/Fahrzeug}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/aud/ab_1/parkhaus/Parkplatz}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/aud/ab_1/parkhaus/Parkhaus}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/aud/ab_1/parkhaus/MeinParkhaus}
\end{liAntwort}
