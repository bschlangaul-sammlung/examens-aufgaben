...
\liJavaDatei[firstline=4,lastline=14]{aufgaben/sosy/ab_7/Aufgabe2}
...
\path (0) -- (1);
\path[wahr] (1) -- (2) \liBedingung{above right}{until > 0};
\path[falsch] (1) -- (6) \liBedingung{left}{until <= 0};
\path[wahr] (2) -- (3) \liBedingung{above right}{i <= until};
\path[falsch] (2) -- (6);
\path[wahr] (3) -- (4) \liBedingung{above right}{i \% 4 == 0 || i \% 6 == 0};
\path[falsch] (3) -- (5);
\path (4) -- (5);
\path (5) -- (2);
...
die erste if-Bedingung \liJavaCode{false} wird.
