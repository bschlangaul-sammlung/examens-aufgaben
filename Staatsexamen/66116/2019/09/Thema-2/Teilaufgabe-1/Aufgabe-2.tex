...
\liJavaExamen[firstline=4,lastline=11]{66116}{2019}{09}{Assertion}
...
\begin{liAntwort}
\liJavaExamen[firstline=13,lastline=39]{66116}{2019}{09}{Assertion}
\end{liAntwort}
...
\begin{liAntwort}
\liFussnoteUrl{https://de.wikipedia.org/wiki/Design_by_contract}
\end{liAntwort}

\end{enumerate}

\begin{liAdditum}[Die komplette Klasse]
