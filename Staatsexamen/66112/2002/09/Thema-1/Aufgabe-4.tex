...
\liLadePakete{syntax}
\begin{document}
\liAufgabenTitel{Banksystem}

\section{Aufgabe 1: Vererbung\index{Vererbung} und Abstrakte Klassen\index{Abstrakte Klasse}
\footcite[Thema 1 Aufgabe 4)]{examen:66112:2002:09}
}
...
\begin{liAntwort}
Bemerkung: Die Methode \liJavaCode{einzahlen} ist in der Klasse \liJavaCode{Konto}
implementiert, da sie sich für Spar- und Girokonten nicht unterscheidet
im Gegensatz zur Methode \liJavaCode{abheben}, die in beiden Klassen
...
geführt ist, können die Werte für das \liJavaCode{Besitzer}-Objekt übernommen
werden. Schreiben Sie daher eine Hilfsmethode \liJavaCode{Besitzer
schonVorhanden(String name, int kunr)}, die prüft, ob der Kunde mit
\liJavaCode{name} und \liJavaCode{kunr} schon in der Liste vorhanden ist und diesen
...
Aufgabe:
\\
\liJavaCode{public int size()}: Returns the number of elements in this
list.
\\
\liJavaCode{public boolean isEmpty()}: Returns true if this list contains no
elements.
\\
\liJavaCode{public E get(int index)}: Returns the element at the specified
position in this list.
\\
\liJavaCode{public boolean add(E e)}: Appends the specified element to the end of this list.
\\
(siehe auch Java-Api: https://docs.oracle.com/javase/7/docs/api/java/util/ArrayList.html)}

\begin{liAntwort}
\liJavaDatei[firstline=3]{aufgaben/oomup/examen_66112_2002_09/Bank}
\liJavaDatei[firstline=3]{aufgaben/oomup/examen_66112_2002_09/Konto}
\liJavaDatei[firstline=3]{aufgaben/oomup/examen_66112_2002_09/Sparkonto}
\liJavaDatei[firstline=3]{aufgaben/oomup/examen_66112_2002_09/Girokonto}
\liJavaDatei[firstline=3]{aufgaben/oomup/examen_66112_2002_09/Besitzer}
\end{liAntwort}
\end{enumerate}
