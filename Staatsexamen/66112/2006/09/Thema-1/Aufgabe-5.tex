...
\umlclass[below left=1cm and -0.5cm of Passagier]{PrivatKunde}{- alter: int}{}
\umlclass[below right=1cm and -0.5cm of Passagier]{GeschäftsKunde}{
  - flugmeilen: double
}
{+ gewähreRabatt()}

\umlassoc{Passagier}{Sitzplatz}
\umlassoc{Flugbuchung}{Sitzplatz}
