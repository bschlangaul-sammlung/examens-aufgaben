...
\liUmlLeserichtung{bietetAn}

\umlclass[below=2cm of Flugroute]{Flug}{
  + flugnummer: int\\
  + abflugzeit: int\\
  + ankunftszeit: int\\
}{
...
\umlclass[below=1cm of Flugbuchung]{Passagier}{+ adresse}{}

\umlclass[below left=1cm and -0.5cm of Passagier]{PrivatKunde}{}{}
\umlclass[below right=1cm and -0.5cm of Passagier]{GeschäftsKunde}{+ flugmeilen}{+ gewähreRabatt()}
\umlclass[below left=1cm and -0.5cm of PrivatKunde]{Erwachsener}{+ flugmeilen}{}
\umlclass[below right=1cm and -0.5cm of PrivatKunde]{Jugendlicher}{}{+ gewähreRabatt()}
