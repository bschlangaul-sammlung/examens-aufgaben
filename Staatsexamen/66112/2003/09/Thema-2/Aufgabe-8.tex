...
Ausgeben der Attribute \liJavaCode{zahl}, \liJavaCode{linker_teilbaum} und
\liJavaCode{rechter_teilbaum}. Design: eine Klasse \liJavaCode{Knoten} und eine
Klasse \liJavaCode{BinBaum}. Ein Knoten hat einen linken und einen rechten
...
\item Schreiben Sie eine Methode \liJavaCode{fuegeEin(...)}, die eine Zahl in
den Baum einfügt!
...
\item Schreiben Sie eine Methode \liJavaCode{postOrder(...)}, die die Zahlen
...
\liJavaCode{summe(...)}, die die Summe der Zahlen des Unterbaums, dessen
...
\item Implementieren Sie eine Operation \liJavaCode{isSorted(...)}, die für
