...
\begin{liRmodell}
\liRelationMenge{Springer}{\liPrimaer{Startnummer}, Nachname, Vorname, Geburtsdatum, Körpergröße}

\liRelationMenge{Sprung}{\liPrimaer{SID}, Beschreibung, Schwierigkeit}

\liRelationMenge{springt}{\liPrimaer{SID, Startnummer, Durchgang}}
