...
\liLadePakete{petri}
\begin{document}
\liAufgabenTitel{Petri-Netz}

\section{Aufgabe 2: „Petri-Netze“
\index{Petri-Netz}
\footcite{sosy:pu:4}}
...
Kapazität von Stelle A oder alternativ die Inhibitor-Kante von A zu t3
(beides ist hier semantisch äquivalent).
