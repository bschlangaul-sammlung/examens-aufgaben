...
\section{Hotel-Verwaltung\footcite[leicht verändert, Thema 2, TA2, Aufgabe 1]{examen:46116:2012:03}}
...
\node [above left=0.1cm and -0.7cm of angestellter-1] {ist angestellt \LeserichtungRechts};

\umlHVassoc[mult1=1..*,mult2=1,pos2=1.9]{Gast}{Gästezimmer}

\umlVHassoc[anchor1=-140,mult1=1..*,mult2=1..*,pos2=1.9, arg=betreut\LeserichtungRechts]
{Servicekraft}{Gast}
\umlVHVassoc[arm1=5cm,anchor1=-140,mult1=1..*,mult2=1..*,pos2=1.9, arg=reinigt\LeserichtungRechts]
{Servicekraft}{Gästezimmer}

\umlVHVassoc[anchor1=40,anchor2=125,arm1=0.5cm,arg=arbeitet in\LeserichtungRechts,pos=1.5]{Küchenmitarbeiter}{Küche}
\end{tikzpicture}
\end{document}
