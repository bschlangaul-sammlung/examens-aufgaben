...
\bLadePakete{uml}
\begin{document}
\bAufgabenTitel{Hotel-Verwaltung}
...
\umlVHassoc[anchor1=-140,mult1=1..*,mult2=1..*,pos2=1.9, arg=betreut\bLeserichtungRechts]
{Servicekraft}{Gast}
\umlVHVassoc[arm1=5cm,anchor1=-140,mult1=1..*,mult2=1..*,pos2=1.9, arg=reinigt\bLeserichtungRechts]
{Servicekraft}{Gästezimmer}

\umlVHVassoc[anchor1=40,anchor2=125,arm1=0.5cm,arg=arbeitet in\bLeserichtungRechts,pos=1.5]{Küchenmitarbeiter}{Küche}
\end{tikzpicture}
\end{document}
