...
\liLadePakete{rmodell,syntax,mathe}
\begin{document}
\liAufgabenTitel{Versicherungsgesellschaft „Insurance Pro“}
\section{Aufgabe 4: SQL (Check-Up)
\footcite[Thema 1 Teilaufgabe 2 Aufgabe 4]{46116:2015:09}}
...
\ttfamily
\noindent
Versicherungsnehmer (\liPrimaer{KNr}, Name, Anschrift, Geburtsdatum)\\

\noindent
Fahrzeug (\liPrimaer{Kennzeichen}, Farbe, Fahrzeugtyp)\\

\noindent
Mitarbeiter (\liPrimaer{MNr}, Name, Kontaktdaten, \liFremd{Abteilung},
Leiter)\\

\noindent
Abteilung (\liPrimaer{ANr}, Bezeichnung, Ort)\\

\noindent
Versicherungsvertrag (\liPrimaer{VNr}, Abschlussdatum, Art,
\liFremd{Versicherungsnehmer}, \liFremd{Fahrzeug},
\liFremd{Mitarbeiter})\\

\noindent
Schadensfall (\liPrimaer{SNr}, Datum, Gesamtschaden, Beschreibung,
\liFremd{Mitarbeiter})\\

\noindent
Beteiligung (\liFremd{Schadensfall}, \liFremd{Fahrzeug},
Fahrzeugschaden)}
