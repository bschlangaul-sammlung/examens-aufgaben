...
\begin{liRmodell}
\liRelationMenge{Kunde}{\liPrimaer{ID}, Vorname, Nachname, PLZ}
\liRelationMenge{Produkt}{\liPrimaer{GTIN}, Bezeichnung, Bruttopreis, MWStSatz)}
\liRelationMenge{Kauf}{\liPrimaer{ID[Kunde], GTIN[Produkt], Datum}, Menge}
\end{liRmodell}
