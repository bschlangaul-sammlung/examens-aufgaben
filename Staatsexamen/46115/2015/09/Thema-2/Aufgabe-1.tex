...
\begin{document}
\liAufgabenTitel{Hashing mit Modulo 8}
...
Datenstrukturen, Übungsblatt 5, Universität Würzburg, Aufgabe 8]{aud:pu:7}
...
\item \liPseudoUeberschrift{Offenes Hashing}

Zur Kollisionsauflösung wird Verkettung
verwendet.

\liPseudoUeberschrift{Beispiel}
...
\item \liPseudoUeberschrift{Geschlossenes Hashing}
...
\liPseudoUeberschrift{Kleines Java-Hilfsprogramm zum Ausrechnen der Sondierungen}

\liJavaDatei[firstline=3]{aufgaben/aud/pu_7/aufgabe_8/Hashing}

\liPseudoUeberschrift{17 einfügen}
...
\liPseudoUeberschrift{4 einfügen}
