...
\bLadePakete{mathe,syntax,vollstaendige-induktion}
\begin{document}
\let\m=\bInduktionMarkierung
\let\e=\bInduktionErklaerung

\bAufgabenTitel{Methode function: Formale Verifikation - Induktionsbeweis}
\section{Aufgabe 4
\index{Vollständige Induktion}
\footcite{examen:46115:2015:09}}

Gegeben sei die folgende Methode \bJavaCode{function}:
...
& \e{minus plus ist minus}\\
%
& = 1 +
    \frac{\m{-1} - n}{(n + 1) \cdot (n + 2)}
& \e{eins minus zwei ist minus eins}\\
%
& = 1 +
