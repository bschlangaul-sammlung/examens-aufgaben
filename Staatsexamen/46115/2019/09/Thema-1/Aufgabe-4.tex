...
\liLadePakete{syntax,mathe,sortieren}
\begin{document}
\liAufgabenTitel{(Sortierverfahren)}
\section{Aufgabe 4
\index{Selectionsort}
...
\begin{liAntwort}
\def\u#1{\liPseudoUeberschrift{nach #1. Durchlauf ( $j = #1$ )}}
\let\v=\liVertauschen
...
Die Funktion \mintinline{componentpascal}{min_index(A, x, y)} berechnet
...
\mintinline{componentpascal}{rek_selection _sort(A, n, 1)}
...
\liJavaDatei[firstline=3]{examen/examen_46115/jahr_2019/herbst/SelectionSort}
\end{document}
