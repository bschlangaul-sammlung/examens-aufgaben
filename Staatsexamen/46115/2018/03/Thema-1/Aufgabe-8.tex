...
\liLadePakete{graph}
\begin{document}
\liAufgabenTitel{Prim nach Adjazenzmatrix, Tripelnotation}
\section{Aufgabe
\index{Algorithmus von Prim}
\footcite{46115:2018:03}}
...
\liPseudoUeberschrift{Kompletter Graph}
...
\liPseudoUeberschrift{Tabelle schwarz-graue-Knoten}
...
\liPseudoUeberschrift{Minimaler Spannbaum}
