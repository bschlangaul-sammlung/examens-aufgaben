...
\section{Aufgabe 6: Rekursion\footcite[(entnommen aus Algorithmen und Datenstrukturen, Übungsblatt 2, Universität Würzburg)]{aud:pu:7}}
...
und
$\binom{n}{n} = 1$
auch folgende Formeln: \footcite[Staatsexamen Theoretische Informatik,
Algorithmen und Datenstrukturen, Realschulen, Frühjahr 2014, Thema 2,
Aufgabe 4]{examen:46115:2014:03}
...
\item Implementieren Sie unter Verwendung von Beziehung (A) eine
rekursive Methode \java{binRek(n, k)} zur Berechnung des
Binomialkoeffizienten in einer objektorientierten Programmiersprache
oder entsprechendem Pseudocode!
...
iterative Methode \java{binIt(n, k)} zur Berechnung des
Binomialkoeffizienten in einer objektorientierten Programmiersprache
oder entsprechendem Pseudocode!
