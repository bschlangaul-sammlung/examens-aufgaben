...
\bLadePakete{syntax,baum}
\begin{document}
\bAufgabenTitel{Binärer Suchbaum 17, 7, 21, 3, 10, 13, 1, 5}
...
\begin{bAntwort}
\bJavaDatei[firstline=64,lastline=93]{examen/examen_46115/jahr_2014/fruehjahr/suchbaum/BinaererSuchbaum}
\end{bAntwort}
\end{enumerate}
...
\bJavaDatei{examen/examen_46115/jahr_2014/fruehjahr/suchbaum/BinaererSuchbaum}

\bPseudoUeberschrift{Klasse „Knoten“}

\bJavaDatei{examen/examen_46115/jahr_2014/fruehjahr/suchbaum/Knoten}
\end{bAntwort}
\end{document}
