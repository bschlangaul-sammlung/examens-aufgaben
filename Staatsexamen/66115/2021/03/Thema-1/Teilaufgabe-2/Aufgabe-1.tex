...
\begin{liAntwort}
\liPseudoUeberschrift{Best-Case}

\liVertauschen{1 2 3 4 5 6 7}

% didaktik.java sortiere 1 2 3 4 5 6 7 -i
\begin{verbatim}
...
\liPseudoUeberschrift{Worst-Case}

\liVertauschen{7 6 5 4 3 2 1}

% didaktik.java sortiere 7 6 5 4 3 2 1 -i
\begin{verbatim}
...
\liVertauschen{1  3  2  6  5  7  4}

% didaktik.java sortiere 1 3 2 6 5 7 4 -q --rechts
\begin{verbatim}
...
% didaktik.java sortiere 1 2 3 4 5 6 7 -q --rechts
\begin{verbatim}
...
% didaktik.java sortiere 1 2 3 4 5 6 7 -q --mitte
\begin{verbatim}
 1  2  3  4  5  6  7  zerlege
 1  2  3  4* 5  6  7  markiere (i 3)
...
\liVertauschen{2 4 6 7 1 5 3}

% didaktik.java sortiere 2 4 6 7 1 5 3  -q --mitte
\begin{verbatim}
