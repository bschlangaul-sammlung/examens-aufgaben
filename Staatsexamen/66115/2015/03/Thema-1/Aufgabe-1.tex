...
\liLadePakete{formale-sprachen,automaten,minimierung,syntax,potenzmengen-konstruktion,pumping-lemma}
\begin{document}
\let\l=\liLeereZelle
\let\f=\liFussnote
\def\z#1{
...
\liAufgabenTitel{Alphabet „01“ Anzahl Unterschied höchstes 3}
\section{Aufgabe 1
