...
Sei M 0 , M 1 , . . . eine Gödelisierung aller Registermaschinen (RAMs). Geben Sie
für die folgenden Mengen D 1 , D 2 , D 3 an, ob sie entscheidbar oder aufzählbar
sind. Begründen Sie Ihre Behauptungen, wobei Sie die Aufzählbarkeit und Un-
entscheidbarkeit des speziellen Halteproblems
K 0 = {x ∈ N|M x haelt bei Eingabe x}
verwenden dürfen.
D 1 = {x ∈ N|x < 9973und M x haelt bei Eingabe x}
D 2 = {x ∈ N|x ≥ 9973und M x haelt bei Eingabe x}
D 3 = {x ∈ N|M x haelt nicht bei Eingabe x}
