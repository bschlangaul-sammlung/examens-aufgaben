...
\path[li graph kante] (a) edge node {7} (b);
\path[li graph kante] (a) edge (d);
\path[li graph kante] (b) edge node {6} (c);
\path[li graph kante] (b) edge node {4} (d);
\path[li graph kante] (b) edge node {9} (e);
\path[li graph kante] (c) edge node {8} (e);
\path[li graph kante] (d) edge node {13} (e);
\path[li graph kante] (d) edge node {12} (f);
\path[li graph kante] (d) edge node {5} (g);
\path[li graph kante] (e) edge node {10} (f);
\path[li graph kante] (e) edge node {2} (h);
\path[li graph kante] (f) edge node {11} (g);
