...
\begin{document}
\liAufgabenTitel{Notation des Informatik-Duden}
\section{Aufgabe 5 (Sortierverfahren)
\index{Quicksort}
...
\liPseudoUeberschrift{Umsetzung in Java:}

\liJavaDatei[firstline=6,lastline=32]{examen/examen_66115_2019_09/QuickSort}
