...
\begin{liAntwort}
4
\liFussnoteUrl{https://www.youtube.com/watch?v=ceJW9kAplVY}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaExamen[firstline=42,lastline=56]{66115}{2019}{03}{Muffin}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaExamen[firstline=67,lastline=77]{66115}{2019}{03}{Muffin}
\end{liAntwort}
...
\liJavaExamen{66115}{2019}{03}{Muffin}
\end{liAdditum}
\end{document}
