...
\begin{tikzpicture}[li turingmaschine]
  ...
  \liTuringKante[above]{q0}{q4}{
    Y, Y, R;
  }

  \liTuringKante[above]{q1}{q2}{
    b, Y, R;
  }
  ...
  \liTuringKante[above,bend left]{q3}{q0}{
    X, X, R;
  }

  \liTuringKante[above]{q4}{q5}{
    LEER, LEER, L;
  }

  \liTuringKante[above,loop below]{q4}{q4}{
    Y, Y, R;
    Z, Z, R;
  }
\end{tikzpicture}
\end{center}
\liFlaci{Apew1n7g9}
\liFussnoteUrl{https://scanftree.com/automata/turing-machine-for-a-to-power-n-b-to-power-n-c-to-power-n}
\end{liAntwort}
...
\liFussnoteUrl{https://www.youtube.com/watch?v=vwnz9e_Lrfo}
\end{description}
\end{liAntwort}
\end{enumerate}
...
\item Sei \liAlphabet{0, 1}. Jedes $w \in \Sigma^*$ kodiert eine
