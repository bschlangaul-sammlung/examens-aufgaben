...
\leq 46$ aufgerufen werden, so dass der Datentyp \liJavaCode{long} zur
Darstellung aller Werte ausreicht.

\begin{liExkurs}[Fibonacci-Folge]
...
\begin{liAntwort}
\liJavaExamen[firstline=16,lastline=28]{66115}{2017}{03}{Fibonacci}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaExamen[firstline=30,lastline=57]{66115}{2017}{03}{Fibonacci}
\end{liAntwort}
...
\begin{liAntwort}
\liJavaExamen[firstline=59,lastline=81]{66115}{2017}{03}{Fibonacci}
\end{liAntwort}
\end{enumerate}
...
\liJavaExamen{66115}{2017}{03}{Fibonacci}

\liPseudoUeberschrift{Test}

\liJavaTestDatei{examen/examen_66115/jahr_2017/fruehjahr/FibonacciTest}
\end{liAdditum}
