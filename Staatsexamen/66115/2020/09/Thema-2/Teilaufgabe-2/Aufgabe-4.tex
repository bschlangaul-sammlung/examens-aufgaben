...
\liJavaCode{table[W.length][G]}, löst das Gutscheinproblem. Steht hier
\liJavaCode{true}, dann gibt es eine Teilfolge der Waren, die den
Gutscheinbetrag genau ausnutzt.

\end{liAntwort}
\begin{liAdditum}[Test-Klasse]
