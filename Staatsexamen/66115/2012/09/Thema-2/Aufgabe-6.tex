...
$f \colon \mathbb{N} \rightarrow \mathbb{N}$ und
$g \colon \mathbb{N} \rightarrow \mathbb{N}$, wobei $f (n) = (n - 1)^3$ und $g(n) = (2n + 3)(3n +
2)$. Geben Sie an, welche der folgenden Aussagen gelten. Beweisen Sie
Ihre Angaben.
...
\begin{liExkurs}[Regel von L’Hospital]
