...
\item Für einen Graphen G und einen Knoten v von G berechnet KK(G,v) (siehe Abbildung 1) die
...
\item Wenn man den Algorithmus KK für jeden Knoten eines Graphen G aufruft, kann man die Länge
...
\item Geben Sie einen Algorithmus KKschnell(G, v) an, der in O(n +m) Zeit die Länge des kürzesten
