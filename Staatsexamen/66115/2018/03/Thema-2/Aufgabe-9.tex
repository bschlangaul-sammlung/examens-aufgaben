...
\path[li graph kante] (a) edge node {4} (c);
\path[li graph kante] (a) edge node {9} (f);
\path[li graph kante] (b) edge node {6} (e);
\path[li graph kante] (b) edge node {4} (g);
\path[li graph kante] (b) edge node {3} (s);
\path[li graph kante] (c) edge node {7} (d);
\path[li graph kante] (c) edge node {5} (e);
\path[li graph kante] (c) edge (f);
\path[li graph kante] (d) edge node {3} (e);
\path[li graph kante] (d) edge node {4} (f);
\path[li graph kante] (d) edge node {8} (s);
\path[li graph kante] (e) edge node {4} (g);
\path[li graph kante] (e) edge node {13} (s);
\path[li graph kante] (g) edge node {3} (h);
\path[li graph kante] (h) edge node {5} (s);
\end{tikzpicture}
\end{center}
...
\liPseudoUeberschrift{Alternativer Lösungsweg}
...
\path[li graph kante] (a) edge node {2} (c);
\path[li graph kante] (b) edge node {-7} (c);
\end{tikzpicture}
...
\path[li graph kante] (a) edge node {10} (b);
\path[li graph kante] (a) edge node {2} (c);
\path[li graph kante] (b) edge node {-9} (c);
\end{tikzpicture}
