...
\item Geben Sie eine Methode \liJavaCode{Stapel merge(Stapel s, Stapel
...
\dh \liJavaCode{S.pop()} liefert das größte Element in \liJavaCode{s}
zurück und \liJavaCode{T.pop()} liefert das größte Element in
\liJavaCode{t} zurück. Als Hilfsdatenstruktur dürfen Sie nur Stapel
verwenden, keine Felder oder Listen.

\noindent
Hinweis: Nehmen Sie an, dass Objekte der Klasse \liJavaCode{Element},
die auf dem Stapel liegen mit \liJavaCode{compareTo()} vergleichen
werden können. Zum Testen haben wir Ihnen eine Klasse
\liJavaCode{StapelTest} zur Verfügung gestellt, sie können Ihre Methode
...
\liPseudoUeberschrift{Komplette Klasse Stapel}

\liJavaExamen{66115}{2014}{09}{Stapel}

\liPseudoUeberschrift{Komplette Klasse Element}

\liJavaExamen{66115}{2014}{09}{Element}

\liPseudoUeberschrift{Test-Klasse}

\liJavaTestDatei{examen/examen_66115/jahr_2014/herbst/StapelTest}
\end{liAntwort}
