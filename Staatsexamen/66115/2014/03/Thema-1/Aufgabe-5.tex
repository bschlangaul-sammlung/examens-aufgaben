...
\item Definieren Sie die zum Halteproblem für Turing-Maschinen bei
fester Eingabe $m \in \mathbb{N}_0 = \{ 0, 1, 2, \dots \}$ gehörende
Menge $H_m$.
\footcite[Seite 55]{theo:fs:3}

\begin{liAntwort}
\liAusdruck[H_m]{c(M) \in \mathbb{N}}{c(M)\text{ hält auf Eingabe }m},
