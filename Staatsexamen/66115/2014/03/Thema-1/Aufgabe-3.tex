...
\liLadePakete{baum}
\begin{document}
\liAufgabenTitel{Einfügen und dreimal einen Knoten löschen}
\section{Aufgabe 3
\index{AVL-Baum}
...
\begin{liDiagramm}{Nach Löschen von „4“}
\begin{tikzpicture}[li binaer baum]
\Tree
[.\node[label=-1]{10};
  [.\node[label=+1]{5};
...
\begin{liDiagramm}{Nach Löschen von „7“}
\begin{tikzpicture}[li binaer baum]
\Tree
[.\node[label=-2]{6};
  [.\node[label=+1]{2};
...
\begin{liDiagramm}{Nach Löschen von „5“:}
\begin{tikzpicture}[li binaer baum]
\Tree
[.\node[label=-1]{10};
  [.\node[label=-1]{6};
