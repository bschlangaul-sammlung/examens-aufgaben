...
\bAufgabenMetadaten{
  ...
  ZitatBeschreibung = {Thema 1 Aufgabe 1b Seite 2-3},
  BearbeitungsStand = unbekannt,
  Korrektheit = unbekannt,
  Stichwoerter = {Rekursion, Vollständige Induktion, Implementierung in Java},
...
\item Gegeben\index{Rekursion}
\index{Vollständige Induktion}
\footcite[Seite 2-3]{examen:66115:2014:03} sei die Methode \bJavaCode{BigInteger lfBig(int n)} zur
