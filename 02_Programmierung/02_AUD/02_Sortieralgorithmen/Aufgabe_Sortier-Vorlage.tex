...
\item Vervollständige die Methode \liJavaCode{selectionSort()}.\index{Selectionsort}

\begin{antwort}
\liJavaDatei[firstline=65,lastline=91]{aufgaben/aud/ab_2/Sortieralgorithmen}
\end{antwort}
...
\item Vervollständige die Methode \liJavaCode{bubbleSort()}.\index{Bubblesort}

\begin{antwort}
\liJavaDatei[firstline=93,lastline=118]{aufgaben/aud/ab_2/Sortieralgorithmen}
\end{antwort}
\end{enumerate}
\end{document}
