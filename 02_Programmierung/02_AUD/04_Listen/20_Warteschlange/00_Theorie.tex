...
\liJavaCode{insert()} bzw. \liJavaCode{enqueue()}, die Operation zum
Entfernen eines Elements oft \liJavaCode{remove()} bzw.
\liJavaCode{dequeue()} genannt.
...
\liJavaDatei{liste/WarteschlangeFehler}
\liJavaDatei{liste/Warteschlange}
\liJavaDatei{liste/FeldWarteschlange}
