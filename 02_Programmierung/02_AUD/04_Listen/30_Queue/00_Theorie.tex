...
%
Die Operation zum Hinzufügen eines Elements wird oft \liJavaCode{insert()}
bzw. \liJavaCode{enqueue()}, die Operation zum Entfernen eines Elements oft
\liJavaCode{remove()} bzw. \liJavaCode{dequeue()} genannt.
