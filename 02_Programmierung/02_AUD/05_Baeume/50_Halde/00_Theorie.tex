...
Wir \memph{ersetzen} das zu löschende Element mit dem \memph{letzten Element der
untersten Ebene}.
%
Solange die Halden-Eigenschaft in einem Teilbaum verletzt ist, lassen
wir das neue Element entsprechend der Halden-Eigenschaft \memph{nach unten
sickern}.
%
Bei einer \memph{Min-Heap} wird mit dem \memph{kleineren Kind} getauscht, bei einer
\memph{Max-Heap} mit dem \memph{größeren Kind}.
