...
\begin{liAntwort}
\begin{liRmodell}
\liRelation{Kurs}{\liPrimaer{KursNr}, Kursname}

\liRelation{Tutor}{\liPrimaer{PersNr}, Name, Buero}
\end{liRmodell}

bzw.

\begin{liRmodell}
\liRelation{Kurs}{KursNr, \liPrimaer{Kursname}}

\liRelation{Tutor}{PersNr, \liPrimaer{Name, Buero}}
\end{liRmodell}
\end{liAntwort}
...
\begin{liRmodell}
\liRelation{betreut}{\liPrimaer{PersNr}, KursNr, Sprechstunde)}
\liRelation{betreut}{PersNr, \liPrimaer{KursNr}, Sprechstunde)}
\liRelation{betreut}{\liPrimaer{PersNr}, Kursname, Sprechstunde)}
\liRelation{betreut}{PersNr, \liPrimaer{Kursname}, Sprechstunde)}
\liRelation{betreut}{\liPrimaer{Name, Büro}, KursNr, Sprechstunde)}
\liRelation{betreut}{Name, Büro, \liPrimaer{KursNr}, Sprechstunde)}
\liRelation{betreut}{\liPrimaer{Name, Büro}, Kursname, Sprechstunde)}
\liRelation{betreut}{Name, Büro, \liPrimaer{Kursname}, Sprechstunde)}
\end{liRmodell}
\end{liAntwort}
\end{enumerate}
\end{document}
