...
\begin{liAntwort}
\begin{liRmodell}
\liRelation{Abteilung}{\liPrimaer{AbtID}, AName}
\liRelation{Mitarbeiter}{\liPrimaer{PersID}, MName}
\liRelation{Projekt}{\liPrimaer{ProjID}, PName}
\liRelation{gehörtZu}{\liPrimaer{PersID, AbtID}}
\liRelation{arbeitetMit}{\liPrimaer{PersID}, ProjID}
\liRelation{istChefvon}{\liPrimaer{PersID}, VorID}
\liRelation{verantfür}{PersID, \liPrimaer{ProjID}}
\end{liRmodell}
\end{liAntwort}
...
\begin{liAntwort}
\begin{liRmodell}
\liRelation{Abteilung}{AbtID, AName}
\liRelation{Mitarbeiter}{PersID, MName, AbtID, VerantwortlicherID}
\end{liRmodell}
...
\begin{liRmodell}
\liRelation{Projekt}{ProjID, PName, VerantwortlicherID}
\end{liRmodell}
...
\begin{liRmodell}
\liRelation{arbeitetMit}{PersID, ProjID}
\end{liRmodell}
\end{liAntwort}
\end{enumerate}
\end{document}
