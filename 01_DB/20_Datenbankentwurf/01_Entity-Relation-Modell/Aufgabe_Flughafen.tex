...
\liLadePakete{syntax,er,mathe,rmodell}
\begin{document}
...
Fluggesellschaft(\liPrimaer{FGName}, Hauptsitz)

Flug(\liPrimaer{Flug-Nr}, Abflugzeit, Zielflughafen,
\liFremd{FGName[Fluggesellschaft]},
\liFremd{FZ-Nr[Flugzeug]})

Flugzeug(\liPrimaer{FZ-Nr},
\liFremd{FGName[Fluggesellschaft]},
DatumErsterEinsatz,
\liFremd{Typ-Nr[Flugzeugtyp]})

Flugzeugtyp(\liPrimaer{Typ-Nr}, SitzplatzAnzahl, GroesseBesatzung)

Passagier(\liPrimaer{Pass-Nr}, Name, Gebdat)

buchen(\liFremd{Pass-Nr[Passagier]},
\liFremd{Flug-Nr[Flug]}, Sitzplatz-Nr)
}
\end{antwort}
