...
\item Finden Sie den einzigen Schlüsselkandidaten von ARTBEST.
...
\tmptt{AttrHülle(F, \{ArtNr, Lieferant, BestDat, EP\}) = \\
\{
  ArtNr,
  Lieferant,
  BestDat,
...
\tmptt{AttrHülle(F, \{Lieferant, BestDat, EP\}) = \\
\{
  Lieferant,
  BestDat,
  EP,
...
\tmptt{AttrHülle(F, \{ArtNr, BestDat, EP\}) = \\
\{
  ArtNr,
  BestDat,
  EP,
...
\tmptt{AttrHülle(F, \{ArtNr, Lieferant, EP\}) = \\
\{
  ArtNr,
  Lieferant,
  EP,
...
\tmptt{AttrHülle(F, \{ArtNr, Lieferant, BestDat\}) = \\
\{
  ArtNr,
  Lieferant,
  BestDat,
...
so verschindet auch die Hersteller-Telefonnumer von manchen
Herstelllern.
\end{mdframed}
...
\tmptt{Anzahl $\notin$ AttrHülle(F, \{Lieferant, BestDat\}) = \\
\{
  Lieferant,
  BestDat,
  LiefTel
...
\tmptt{Anzahl $\notin$ AttrHülle(F, \{ArtNr, BestDat\}) = \\
\{
  ArtNr,
  BestDat,
  ArtName,
...
\tmptt{Anzahl $\notin$ AttrHülle(F, \{ArtNr, Lieferant\}) = \\
\{
  ArtNr,
  Lieferant,
  ArtName,
...
\tmptt{HerstTel $\in$ AttrHülle(F - \{ArtNr $\rightarrow$ HerstTel\}, \{ArtNr\}) = \\
\{
  ArtNr,
  ArtName,
  ArtArt,
...
\item Erfernung überflüssiger Teilschemata
