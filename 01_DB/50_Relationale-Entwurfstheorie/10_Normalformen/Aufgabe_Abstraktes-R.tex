...
\begin{itemize}
\item \fa{E -> D}: $\ah{F - \m{E \rightarrow D}, \m{E}} = \m{E}$, d.h.
$D \notin \ah{F - \m{E \rightarrow D}, \m{E}}$

\item \fa{C -> B}: $\ah{F - \m{C \rightarrow B}, \m{C}} = \m{C}$, d.h.
$B \notin \ah{F - \m{C \rightarrow B}, \m{E}}$

\item \fa{CE -> G}: $\ah{F - \m{CE \rightarrow G}, \m{C, E}} = \m{A, B, C, D, E}$, d.h.
$G \notin \ah{F - \m{CE \rightarrow G}, \m{E}}$
$\Rightarrow$ $CE \rightarrow G$ ist nicht redundant

\item \fa{B -> A}: $\ah{F - \fa{B -> A}, \m{B}} = \m{B}$, d.h.
