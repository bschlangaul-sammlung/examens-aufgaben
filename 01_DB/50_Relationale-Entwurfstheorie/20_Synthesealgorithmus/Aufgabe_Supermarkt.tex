...
HerstTel $\in$ \ah{F - \fa{ArtNr -> HerstTel}, \m{ArtNr}} = \\
\m{
  ArtNr,
  ArtName,
  ArtArt,
...
\liRelation[R1]{ArtNr, ArtName, ArtArt, Hersteller}\\
\liRelation[R2]{Hersteller, HerstTel}\\
\liRelation[R3]{Lieferant, LiefTel}\\
\liRelation[R4]{ArtNr, Lieferant, BestDat, Anzahl}
...
\liRelation[R3]{Lieferant, LiefTel}\\
\liRelation[R4]{ArtNr, Lieferant, BestDat, Anzahl}\\
\liRelation[R5]{ArtNr, Lieferant, BestDat, EP}
