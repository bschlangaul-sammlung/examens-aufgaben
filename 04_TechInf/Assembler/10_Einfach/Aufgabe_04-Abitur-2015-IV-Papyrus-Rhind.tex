...
\liJavaDatei[firstline=6,lastline=16]{aufgaben/tech_info/assembler/ein_adress/AegyptischeMultiplikation}

\liPseudoUeberschrift{Java (rekursiv)}

\liJavaDatei[firstline=18,lastline=31]{aufgaben/tech_info/assembler/ein_adress/AegyptischeMultiplikation}
\end{liAntwort}
